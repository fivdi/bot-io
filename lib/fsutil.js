...
module.exports.PLATFORM_ROOT_PATH = '/sys/devices/platform/';
module.exports.OCP_ROOT_PATH = '/sys/devices/platform/ocp/';
...
module.exports.readString = function (fd, buf) {
  var len = fs.readSync(fd, buf, 0, buf.length, 0);
  return buf.toString('utf8', 0, len - 1); // -1 to ignore newline char
};

module.exports.writeString = function (fd, str) {
  if (fd !== -1) {
    fs.writeSync(fd, str);
  }
};
